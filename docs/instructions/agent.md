...
> このドキュメントは Claude / Codex 両方で共通利用されます。
...
- PANE_INDEX=1 → エージェント 1
- PANE_INDEX=2 → エージェント 2
- PANE_INDEX=3 → エージェント 3
...
- ⚠️ **自分のエージェント番号の完了ファイルのみ作成**（PANE_INDEX 環境変数を使用）
